...
import {APPROVED_CAMPAIGNS_QUERY} from "./queries";
import Link from "next/link";
import BoolIcon from "../BoolIcon"


class ApprovedCampaignListPage extends React.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
