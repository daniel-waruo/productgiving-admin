    ...
    return (
      <>
        ...
        <MDBContainer>
          ...
          <p>At Next Js Commerse, accessible from https://next-js-e-commerse.now.sh/, one of our main priorities is the
            privacy of our visitors. This Privacy Policy document contains types of information that is collected and
            recorded by Next Js Commerse and how we use it.</p>
          ...
          <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with
            regards to the information that they shared and/or collect in Next Js Commerse. This policy is not
            applicable
          ...
          <p>Next Js Commerse follows a standard procedure of using log files. These files log visitors when they visit
          ...
          <p>Like any other website, Next Js Commerse uses 'cookies'. These cookies are used to store information
          ...
          <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
            used in their respective advertisements and links that appear on Next Js Commerse, which are sent directly
            to
          ...
          <p>Note that Next Js Commerse has no access to or control over these cookies that are used by third-party
            advertisers.</p>

          <h2>Third Party Privacy Policies</h2>

          <p>Next Js Commerse's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising
            you
          ...
          <p>Next Js Commerse does not knowingly collect any Personal Identifiable Information from children under the
            age
