    ...
    return (
      <>
        <NextSeo
          ...
          description={"See our comprehensive privacy policy we care for your data as much as you do."
          }
        />
        <MDBContainer>
          <h1 className={"text-center"}>Privacy Policy for {name}</h1>

          <p>At {name}, accessible from https://next-js-e-commerse.now.sh/, one of our main priorities is the
            privacy of our visitors. This Privacy Policy document contains types of information that is collected and
            recorded by {name} and how we use it.</p>
          ...
          <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with
            regards to the information that they shared and/or collect in {name}. This policy is not
            applicable
          ...
          <p>{name} follows a standard procedure of using log files. These files log visitors when they visit
            ...
            created with the help of the <a href="https://www.privacypolicygenerator.info">Privacy Policy
              Generator</a> and the <a href="https://www.privacypolicytemplate.net/">Privacy Policy Template</a>.</p>

          <h2>Cookies and Web Beacons</h2>

          <p>Like any other website, {name} uses 'cookies'. These cookies are used to store information
          ...
          <p>You may consult this list to find the Privacy Policy for each of the advertising partners of Next Js
            Commerse.</p>

          <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
            used in their respective advertisements and links that appear on {name}, which are sent directly
            to
          ...
          <p>Note that {name} has no access to or control over these cookies that are used by third-party
            advertisers.</p>

          <h2>Third Party Privacy Policies</h2>

          <p>{name}'s Privacy Policy does not apply to other advertisers or websites. Thus, we are advising
            you
            ...
            complete
            list of these Privacy Policies and their links here: Privacy Policy Links.</p>
          ...
          <p>{name} does not knowingly collect any Personal Identifiable Information from children under the
            age
